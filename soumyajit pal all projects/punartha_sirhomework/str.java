...
//Accept two strings and check out whether 2nd string is in the 1st string or not, if it exists then display all the positions within the main string, also count its frequencies.
import java.io.*;
class str
{
