...
class altswap1
{
    ...
    public static void main()
    {
        ...
        System.out.println("Enter a paragraph were each sentence is seperated by '.''?'''1'");// enters paragraph 
        ...
        System.out.println("The largest paragraph is:   "+para.substring(f,l));// displays largest paragraph 
    }
}
